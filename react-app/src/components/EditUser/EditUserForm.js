        ...
        <>
            ...
            <div className='userFormBody'>
                ...
                <form onSubmit={editUserFunc}>
                    ...
                    <div style={{marginLeft:"5px"}}  className="errorMsgText">{!!errors.description && errors.description}{(!!description && description.length > 250) && (` ${description.length}/250`)}</div>
                    <div className='inputField'>
                    ...
                    <div style={{marginLeft:"5px"}} className="errorMsgText">{!!errors.location && errors.location}{(!!location && location.length > 50) && (` ${location.length}/50`)}</div>
